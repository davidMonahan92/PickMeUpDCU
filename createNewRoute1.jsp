...
<head>
	...
	<script>
		...
		{
			alert("sending");	
			$.post("http://localhost:8080/DCU-CarPool-pack-0.1.0/createNewRoute", 
			{
				startPoint:$("#from").val(),
				endPoint:$("#to").val(),
				date:$("#datepicker").val(),
		...
		<div class="row">
			<div class="col-md-4">
				<form class="form-horizontal" id="calculate-route" name="calculate-route" action="#" method="get">
					...
					<!--Enter Driver destination point-->
					<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-6">
						<a href="manageMyPickUpRequests1.jsp">
							<button type="submit" class="btn btn-primary" onclick="updateRoute()">Submit</button>
						</a>
					</div>
				</div>
			</div>
